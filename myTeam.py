...
class OffensiveAgent(CaptureAgent):
  ...
  for n,w in {'walls-near-me': -5.967447877767328e-266, 'Amount-of-Food-Left': 1.1898175413744968e-05, 'Amount-of-Food-Carrying': 0.00033314891158485915, 'closest-ghost-distance': -8.951171816650986e-265, 'Distance-to-home': 1.630385519755503e-43, 'bias': 0.00016657445579242958, 'score': 0.9994467347545775, 'dist-to-best-spot': 4.1643702631496985e-05, 'food-near-me': 1.7738764123034316e-71}.items():
  #{'walls-near-me': 0.0, 'Amount-of-Food-Left': 1.561248910058829e-05, 'Amount-of-Food-Carrying': 0.0004995996512188253, 'score': 0.9991993024376505, 'Distance-to-home': 0.0, 'bias': 0.00024979982560941263, 'closest-ghost-distance': 0.0, 'dist-to-best-spot': 3.568559642064612e-05, 'food-near-me': -0.0}.items():
      weights[n] = w
  epsilon = 0.001
  alpha = 0.02
  discount = 0.8
